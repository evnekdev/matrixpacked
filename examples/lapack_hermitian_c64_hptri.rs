//! Demonstrates ZHPTRI, the LAPACK packed-storage routine.
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let mut storage = [Complex64::new(2.0, 0.0), Complex64::new(1.0, 1.0), Complex64::new(-1.0, 0.0)];
    ...
    assert_slice_close(factor.as_slice(), &[Complex64::new(0.25, 0.0), Complex64::new(0.25, 0.25), Complex64::new(-0.5, 0.0)], 1e-10);
    Ok(())
}
