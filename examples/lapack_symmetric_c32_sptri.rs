...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let mut storage = [Complex32::new(4.0, 0.0), Complex32::new(1.0, 0.0), Complex32::new(3.0, 0.0)];
    ...
    assert_slice_close(factor.as_slice(), &[Complex32::new(0.2727272727272727, 0.0), Complex32::new(-0.09090909090909091, 0.0), Complex32::new(0.36363636363636365, 0.0)], 1e-4);
    Ok(())
}
