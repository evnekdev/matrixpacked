...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let a = PackedLower::<Complex64>::from_vec(2, vec![Complex64::new(2.0, 0.0), Complex64::new(3.0, 0.0), Complex64::new(4.0, 0.0)])?;
    let mut b = [Complex64::new(2.0, 0.0), Complex64::new(11.0, 0.0)];
