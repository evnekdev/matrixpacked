...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    let a = PackedUpper::<Complex32>::from_vec(2, vec![Complex32::new(2.0, 0.0), Complex32::new(3.0, 0.0), Complex32::new(4.0, 0.0)])?;
    let mut b = [Complex32::new(8.0, 0.0), Complex32::new(8.0, 0.0)];
